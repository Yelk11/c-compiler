    ...
    while (parser->current_token->type == TOKEN_SEMI)
    {
        ...
        if (ast_statement)
        {
            ...
            compound->compound_value = realloc(
                ...
                compound->compound_size * sizeof(struct ASST_STRUCT *));
...
AST_T *parser_parse_function_call(parser_T *parser)
{
    ...
    while (parser->current_token->type == TOKEN_COMMA)
    {
        ...
        function_call->function_call_arguments = realloc(
            ...
            function_call->function_call_arguments_size * sizeof(struct ASST_STRUCT *));
...
AST_T *parser_parse_variable_definition(parser_T *parser)
{
    ...
    variable_definition->variable_definition_variable_value = variable_definition_value;
